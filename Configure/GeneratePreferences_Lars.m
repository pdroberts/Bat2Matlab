...
if exist('animal_type','var')
    ...
    %Path definitions
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    prefs.bat2matlab_directory = 'C:\Users\lars\Documents\Matlab\Bat2Matlab';
    ...
    elseif strmatch('mouse',animal_type)
        prefs.audio_directory = [prefs.bat2matlab_directory '\Data\2008Experiments'];
        base_batlab_data_path = [prefs.bat2matlab_directory '\Data\2008Experiments'];
    else
        error('Incorrect animal type specified in GeneratePreferences()');
    end
    prefs.Bat2Matlab_data_filepath = [prefs.bat2matlab_directory '\Data\Extracted Data\' animal_type animal_string experiment_string '.mat'];
    prefs.raw_data_filepath = [base_batlab_data_path '\' animal_type ' ' animal_string '\' animal_type animal_string experiment_string '.raw'];
    prefs.xml_data_filepath = [base_batlab_data_path '\' animal_type ' ' animal_string '\' animal_type animal_string experiment_string '-alltests-nospikes.xml'];
    prefs.pst_data_filepath = [base_batlab_data_path '\' animal_type ' ' animal_string '\' animal_type animal_string experiment_string '.pst'];
    prefs.output_data_filepath = [prefs.bat2matlab_directory '\Output\' animal_type '\' animal_type animal_string experiment_string];
