function prefs = GeneratePreferences(animal_type, ...
                                     animal_string, ...
                                     experiment_string, ...
                                     cell_string)
%
...
if exist('animal_type','var')
    ...
    %Path definitions
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    prefs.bat2matlab_directory = '/Users/robertpa/Documents/Numerical/MATLAB_files/Bat2Matlab';
%     prefs.bat2matlab_directory = '/Documents/PortforsData';
    if strmatch('Bat',animal_type)
        prefs.audio_directory = [prefs.bat2matlab_directory '/Data/Vocalizations/CombinedBatCalls/'];
        base_batlab_data_path = [prefs.bat2matlab_directory '/Data/RawData/BatData'];
    elseif strmatch('Mouse',animal_type)
        prefs.audio_directory = [prefs.bat2matlab_directory '/MouseVocalizations/CBAcallsAdults/'];
%         base_batlab_data_path = [prefs.bat2matlab_directory '/IC07/CBA/'];
%         base_batlab_data_path = [prefs.bat2matlab_directory '/IC09/'];
%         base_batlab_data_path = [prefs.bat2matlab_directory '/IC10_multiunit/'];
        base_batlab_data_path = [prefs.bat2matlab_directory '/data/'];
    else
        error('Incorrect animal type specified in GeneratePreferences()');
    end
    prefs.Bat2Matlab_data_filepath = [prefs.bat2matlab_directory '/Data/ExtractedData/' animal_type animal_string experiment_string '.mat'];
